...
export default function SwipeCarousel ({ cards, autoplay }) {
  ...
  return (
    <div className="w-[91vw] relative overflow-hidden ">
      <motion.div
        drag="x"
        dragConstraints={{
          left: 0,
      ...
      >
        <Cards imgIndex={imgIndex} cards={cards} autoplay={autoplay} />
      </motion.div>
...
function Cards ({ imgIndex, cards, autoplay }) {
  return (
    <>
      {cards.map((card, id) => {
        return (
          ...
          >
            <div className="w-[91vw] h-[300px] rounded-t-[15px] " style={{background: "radial-gradient(100% 100% at 0% 0%, rgba(249, 206, 105, 0.85) 0%, rgba(139, 92, 246, 0.85) 44.59%, rgba(67, 44, 119, 0.85) 85%)"}}>
              <Rive animation={card.animation} autoplay={autoplay}></Rive>
            </div>
            <div dir="rtl" className="flex flex-col gap-[20px] text-white w-[91vw] h-[265px] p-[20px] bg-[#2B2836] rounded-b-[15px] ">
              <div>
